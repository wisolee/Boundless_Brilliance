...
class PresentationDetailController : UIViewController{
    ...
    let Grade: UITextView! = {
        ...
        gf.textAlignment = NSTextAlignment.right
...
//    let Pres2Label: UITextView! = {
//        let te = UITextView()
//        te.textColor = UIColor.black
//        te.text = ""
//        te.isEditable = false
//        te.translatesAutoresizingMaskIntoConstraints = false
//        te.textAlignment = NSTextAlignment.left
//        te.backgroundColor = UIColor.white
//        te.font = .systemFont(ofSize: UIDevice.current.userInterfaceIdiom == .pad ? 15 : 13)
//        return te
//    }()
    ...
    let Pres2Email: UITextView! = {
        ...
        p2e.textAlignment = NSTextAlignment.left
...
//    end examples from the alerts and pickers app cell file-----------------------------
    ...
    func setupInputsView(inputsView: UIScrollView, textField: UITextView, locField: UITextView, namesField: UITextView){
...
//        Pres1Email.text = String(nameArray[0])
//        inputsView.addSubview(Pres2Email)
//        if(nameArray.count > 1){
//            Pres2Email.text! = String(nameArray[1])
//        }
        ...
        GradeLabel.topAnchor.constraint(equalTo: TeacherEmail.bottomAnchor, constant: 6).isActive = true
        GradeLabel.widthAnchor.constraint(equalTo: inputsView.widthAnchor, multiplier: 1/2).isActive = true
        GradeLabel.heightAnchor.constraint(equalToConstant: 40).isActive = true
        GradeLabel.leftAnchor.constraint(equalTo: inputsView.leftAnchor, constant: 15).isActive = true
        ...
        Grade.leftAnchor.constraint(equalTo: GradeLabel.rightAnchor, constant: 15).isActive = true
        
        NamesFieldTitle.topAnchor.constraint(equalTo: Grade.bottomAnchor, constant: 6).isActive = true
        ...
        namesField.topAnchor.constraint(equalTo: Grade.bottomAnchor, constant: 6).isActive = true
...
//        Pres2Email.heightAnchor.constraint(equalToConstant: 40).isActive = true
        ...
        OCTitle.topAnchor.constraint(equalTo: NamesFieldTitle.bottomAnchor, constant: 6).isActive = true
        ...
        OutreachCoordinator.topAnchor.constraint(equalTo: NamesFieldTitle.bottomAnchor, constant: 6).isActive = true
        ...
        leaveInputButton.topAnchor.constraint(equalTo: OutreachCoordinatorEmail.bottomAnchor, constant: 10).isActive = true
        leaveInputButton.leftAnchor.constraint(equalTo: inputsView.leftAnchor, constant: 10).isActive = true
        leaveInputButton.widthAnchor.constraint(equalTo: inputsView.widthAnchor).isActive = true
